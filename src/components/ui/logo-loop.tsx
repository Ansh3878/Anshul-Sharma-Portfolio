...
export interface LogoLoopProps {
  ...
  renderItem?: (logo: any, index: number) => React.ReactNode;
  ariaLabel?: string;
  className?: string;
      ...
      () => {
        ...
        if (fadeOut) {
          ...
          const maskImage = isVertical
            ? `linear-gradient(to bottom, transparent 0%, black ${fadeWidth}, black calc(100% - ${fadeWidth}), transparent 100%)`
            : `linear-gradient(to right, transparent 0%, black ${fadeWidth}, black calc(100% - ${fadeWidth}), transparent 100%)`;
          
          baseStyle.maskImage = maskImage;
          baseStyle.WebkitMaskImage = maskImage;
        }
